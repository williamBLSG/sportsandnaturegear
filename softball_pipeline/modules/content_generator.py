...
"widget_1": "<p>Whether your daughter just signed up for her first rec league...</p><p>This article covers the best fastpitch softball bats available right now...</p>"
...
def regenerate_widget_for_price_change(
    ...
    old_price: float,
    new_price: float,
    all_tier_products: list[SoftballLinkedProduct] | None = None,
) -> str:
